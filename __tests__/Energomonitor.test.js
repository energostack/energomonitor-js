...
describe('Energomonitor', () => {
    ...
    beforeAll(() => {
        ...
        axiosMockAuthorized = new MockAdapter(
            energomonitorAuthorized.getAxiosInstance()
        );
    });
    ...
    describe('.constructor', () => {
        describe('with default axios instance', async () => {
            ...
            it('sets axios instance baseURL to the default value when no apiURL is passed', async () => {
                ...
                expect(
                    energomonitor.getAxiosInstance().defaults['baseURL']
                ).toBe('https://api.energomonitor.com/v1');
            });
    ...
    describe('.authorize', () => {
        ...
        it('sends request to the correct URL', async () => {
            axiosMock.onPost('/authorizations').reply(function(config) {
                expect(config.baseURL + config.url).toBe(
                    'https://api.energomonitor.com/v1/authorizations'
                );
        ...
        it('passes the resources parameter to axios config.data', async () => {
            axiosMock.onPost('/authorizations').reply(function(config) {
                expect(config.data).toBe(
                    '{"resources":[{"type":"feed","name":"200242",' +
                        '"permissions":["r"]}]}'
                );
    ...
    describe('.getFeed', () => {
        ...
        it('sends request to the correct URL', async () => {
            axiosMockAuthorized.onGet('/feeds/1').reply(function(config) {
                expect(config.baseURL + config.url).toBe(
                    'https://api.energomonitor.com/v1/feeds/1'
                );
    ...
    describe('.getFeeds', () => {
        it('returns a rejected promise when token is not set', () => {
            return expect(
                energomonitorUnauthorized.getFeeds(1)
            ).rejects.toEqual(
                'Cannot call this method without setting the authorization token ' +
                    '(in the constructor or using the authorize method).'
            );
        ...
        it('sends request to the correct URL', async () => {
            axiosMockAuthorized.onGet('/users/1/feeds').reply(function(config) {
                expect(config.baseURL + config.url).toBe(
                    'https://api.energomonitor.com/v1/users/1/feeds'
                );
    ...
    describe('.getNotification', () => {
        it('returns a rejected promise when token is not set', () => {
            return expect(
                energomonitorUnauthorized.getNotification(1, 2)
            ).rejects.toEqual(
                'Cannot call this method without setting the authorization token ' +
                    '(in the constructor or using the authorize method).'
            );
    ...
    describe('.getNotificationCount', () => {
        it('returns a rejected promise when token is not set', () => {
            return expect(
                energomonitorUnauthorized.getNotificationCount(1)
            ).rejects.toEqual(
                'Cannot call this method without setting the authorization token ' +
                    '(in the constructor or using the authorize method).'
            );
        ...
        it('sends request to the correct URL', async () => {
            axiosMockAuthorized
                .onGet('/users/1/notification_count')
                .reply(function(config) {
                    expect(config.baseURL + config.url).toBe(
    ...
    describe('.getNotifications', () => {
        it('returns a rejected promise when token is not set', () => {
            return expect(
                energomonitorUnauthorized.getNotifications(1)
            ).rejects.toEqual(
                'Cannot call this method without setting the authorization token ' +
                    '(in the constructor or using the authorize method).'
            );
        ...
        it('converts the createdAtFrom parameter to ISO 8601 and passes it to axios config.params', async () => {
            const createdAtFromDate = new Date(
                Date.UTC(2017, 3, 22, 16, 30, 0)
            );
            ...
            await energomonitorAuthorized.getNotifications(
                1,
                createdAtFromDate
            );
        });
    ...
    describe('.getRelatedStreams', () => {
        it('returns a rejected promise when token is not set', () => {
            return expect(
                energomonitorUnauthorized.getRelatedStreams(1)
            ).rejects.toEqual(
                'Cannot call this method without setting the authorization token ' +
                    '(in the constructor or using the authorize method).'
            );
    ...
    describe('.getStream', () => {
        it('returns a rejected promise when token is not set', () => {
            return expect(
                energomonitorUnauthorized.getStream(1, 2)
            ).rejects.toEqual(
                'Cannot call this method without setting the authorization token ' +
                    '(in the constructor or using the authorize method).'
            );
    ...
    describe('.getStreamData', () => {
        it('returns a rejected promise when token is not set', () => {
            return expect(
                energomonitorUnauthorized.getStreamData(1, 2)
            ).rejects.toEqual(
                'Cannot call this method without setting the authorization token ' +
                    '(in the constructor or using the authorize method).'
            );
        ...
        it('converts the timeTo parameter to a timestamp and passes it to axios config.params', async () => {
            ...
            await energomonitorAuthorized.getStreamData(
                1,
                2,
                undefined,
                timeToDate
    ...
    describe('.getStreams', () => {
        it('returns a rejected promise when token is not set', () => {
            return expect(
                energomonitorUnauthorized.getStreams(1)
            ).rejects.toEqual(
                'Cannot call this method without setting the authorization token ' +
                    '(in the constructor or using the authorize method).'
            );
        ...
        it('converts the dataTimeFrom parameter to a timestamp and passes it to axios config.params', async () => {
            ...
            const dataTimeFromDate = new Date(
                Date.UTC(2017, 9, 28, 20, 29, 40)
            );
            ...
            await energomonitorAuthorized.getStreams(
                1,
                undefined,
                undefined,
                dataTimeFromDate
    ...
    describe('.getUser', () => {
        ...
        it('sends request to the correct URL', async () => {
            axiosMockAuthorized.onGet('/users/1').reply(function(config) {
                expect(config.baseURL + config.url).toBe(
                    'https://api.energomonitor.com/v1/users/1'
                );
    ...
    describe('.updateNotification', () => {
        it('returns a rejected promise when token is not set', () => {
            return expect(
                energomonitorUnauthorized.updateNotification(1, 2)
            ).rejects.toEqual(
                'Cannot call this method without setting the authorization token ' +
                    '(in the constructor or using the authorize method).'
            );
        ...
        it('sends request to the correct URL', async () => {
            axiosMockAuthorized
                .onPatch('/users/1/notifications/2')
                .reply(function(config) {
                    expect(config.baseURL + config.url).toBe(
                        'https://api.energomonitor.com/v1/users/1/notifications/2'
                    );
    ...
    describe('.updateNotifications', () => {
        it('returns a rejected promise when token is not set', () => {
            return expect(
                energomonitorUnauthorized.updateNotifications(1)
            ).rejects.toEqual(
                'Cannot call this method without setting the authorization token ' +
                    '(in the constructor or using the authorize method).'
            );
